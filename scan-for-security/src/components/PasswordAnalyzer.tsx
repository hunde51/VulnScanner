  ...
  const criteriaItems = [
    {
      ...
      check: result?.criteria.length,
    },
    {
      key: "uppercase",
      label: "Uppercase letters (A-Z)",
      check: result?.criteria.uppercase,
    },
    {
      key: "lowercase",
      label: "Lowercase letters (a-z)",
      check: result?.criteria.lowercase,
    },
    { key: "numbers", label: "Numbers (0-9)", check: result?.criteria.numbers },
    {
      key: "special",
      label: "Special characters (!@#$%)",
      check: result?.criteria.special,
    },
    {
      key: "noCommon",
      label: "Not a common password",
      check: result?.criteria.noCommon,
    },
  ];
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {result && (
        <div className="space-y-4 animate-fade-in">
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            <h3 className="font-mono text-lg text-foreground mb-4">
              Password Criteria
            </h3>
